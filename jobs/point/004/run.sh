...
python -m point.data.preprocess                                                ^
  --job-dir gs://vehicle-simulation/jobs/point/004                             ^
...
gcloud ml-engine jobs submit training vehicle_simulation_point_004             ^
  --region us-central1                                                         ^
  --config ./jobs/point/004/config.yaml                                        ^
  ...
  --job-dir gs://vehicle-simulation/jobs/point/004                             ^
  --                                                                           ^
  --train-file gs://vehicle-simulation/jobs/point/004/data/train.csv           ^
  --eval-file gs://vehicle-simulation/jobs/point/004/data/test.csv             ^
...
# Prepare the data set for sequence testing
python -m sequence.data.preprocess                                             ^
  --job-dir ../jobs/point/004                                                  ^
  --data-zip ../data/2017_ford_f150_ecoboost.zip                               ^
  --in-features Pedal_accel_pos_CAN[per]                                       ^
                Brake_pressure_applied_PCM[]                                   ^
                Dyno_Spd[mph]                                                  ^
