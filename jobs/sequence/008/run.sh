...
python3 -m sequence.data.preprocess                                            \
  --job-dir gs://vehicle-simulation/jobs/sequence/008                          \
...
gcloud ml-engine jobs submit training vehicle_simulation_sequence_008_0        \
  --region us-central1                                                         \
  --config ./jobs/sequence/008/config.yaml                                     \
  ...
  --job-dir gs://vehicle-simulation/jobs/sequence/008                          \
  --                                                                           \
  --train-file gs://vehicle-simulation/jobs/sequence/008/data/train.csv        \
