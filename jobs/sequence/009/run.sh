...
python3 -m sequence.data.preprocess                                            \
  --job-dir gs://vehicle-simulation/jobs/sequence/009                          \
...
gcloud ml-engine jobs submit training vehicle_simulation_sequence_009_0        \
  --region us-central1                                                         \
  --config ./jobs/sequence/009/config.yaml                                     \
  ...
  --job-dir gs://vehicle-simulation/jobs/sequence/009                          \
  --                                                                           \
  --train-file gs://vehicle-simulation/jobs/sequence/009/data/train.csv        \
  --eval-file gs://vehicle-simulation/jobs/sequence/009/data/test.csv          \
