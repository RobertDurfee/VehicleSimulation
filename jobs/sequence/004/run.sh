...
python -m sequence.data.preprocess                    ^
  --job-dir gs://vehicle-simulation/jobs/sequence/004 ^
...
gcloud ml-engine jobs submit training vehicle_simulation_sequence_004_0 ^
  --region us-central1                                                  ^
  --scale-tier BASIC                                                    ^
  ...
  --job-dir gs://vehicle-simulation/jobs/sequence/004                   ^
  --config ./jobs/sequence/004/tuning.yaml                              ^
  --                                                                    ^
  --train-file gs://vehicle-simulation/jobs/sequence/004/data/train.csv ^
  --eval-file gs://vehicle-simulation/jobs/sequence/004/data/test.csv   ^
  --optimizer RMSprop                                                   ^
  --learning-rate 0.001                                                 ^
